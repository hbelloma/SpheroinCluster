void do_runanalysisPPminbiasES(Char_t* rootname = "", Int_t nmaxfiles, Int_t startidx)
{
	...
	TString cmd1 = Form("GetSpherocitySpectrumData(\"%s\",\"SOpp13TeV_spec.root\",0,%d,%d)",rootname,nmaxfiles,startidx);
	//TString cmd1 = Form("GetHistosForEqual(\"%s\",\"SOpp13TeV.root\",0,%d,%d)",rootname,nmaxfiles,startidx);

	//TString cmd1 = Form("GetSpherocitySpectrumData(\"test.list\",\"TestSo.root\",0,20,0)");
